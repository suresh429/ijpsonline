package com.journals.ijpsonline.ui.adapter;
...
import com.journals.ijpsonline.R;
import com.journals.ijpsonline.databinding.ArchiveChildListItemBinding;
...
public class ArchiveChildAdapter extends RecyclerView.Adapter<ArchiveChildAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ArchiveChildAdapter.ViewHolder holder, int position) {
        ...
        holder.rowItemBinding.txtArchiveChildName.setText(modelList.get(position).getVolume());
        ...
        holder.rowItemBinding.getRoot().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bundle.putString("ActionBarTitle",modelList.get(position).getVolume());
